        ...
        <div className="row">
          ...
          <tbody className="text-center">
            <tr>
              ...
              <td>Cricket (Girls)</td>
              <td>Hawks</td>
              <td>Falcons Vs Jaguars<br />Warriors Vs Gladiators</td>
            </tr>
            <tr>
              <td>2</td>
              <td>Badminton/Table Tennis (Girls)</td>
              <td>Jaguars</td>
              <td>Falcons Vs Hawks<br />Warriors Vs Gladiators</td>
            </tr>
            <tr>
              <td>3</td>
              <td>Arm Wrestling (Girls)</td>
              <td>Hawks</td>
              <td>Falcons Vs Warriors<br />Gladiators Vs Hawks</td>
            </tr>
            <tr>
              <td>4</td>
              <td>Ludo (Girls)</td>
              <td>Falcons</td>
              <td>Hawks Vs Warriors<br />Jaguars Vs Falcons</td>
            </tr>
            <tr>
              <td>5</td>
              <td>Chess (Girls)</td>
              <td>Hawks</td>
              <td>Falcons Vs Hawks<br />Jaguars Vs Warriors</td>
            </tr>
            <tr>
              <td>6</td>
              <td>Table Football (Girls)</td>
              <td>Gladiators</td>
              <td>Hawks Vs Warriors<br />Falcons Vs Jaguars</td>
            </tr>
            <tr>
              <td>7</td>
              <td>E-Gaming Takken (Girls)</td>
              <td>Hawks</td>
              <td>Warriors Vs Jaguars<br />Falcons Vs Gladiators</td>
            </tr>
            <tr>
              <td>8</td>
            ...
            <tr>
              ...
              <td>Gladiators</td>
              <td>Hawks Vs Falcons<br />Warriors Vs Jaguars</td>
            </tr>
            <tr>
              <td>11</td>
          ...
          <tbody className="text-center">
            <tr>
              ...
              <td>Cricket (Boys)</td>
              <td>Falcons</td>
              <td>Jaguars Vs Gladiators<br />Warriors Vs Falcons</td>
            </tr>
            <tr>
              <td>2</td>
              <td>Snooker</td>
            ...
            <tr>
              ...
              <td>Gladiators</td>
              <td>Falcons Vs Hawks<br />Gladiators Vs Warriors</td>
            </tr>
            <tr>
              <td>5</td>
              <td>Ludo (Boys)</td>
            ...
            <tr>
              ...
              <td>Jaguars</td>
              <td>Hawks Vs Warriors<br />Falcons Vs Gladiators</td>
            </tr>
            <tr>
              <td>8</td>
              <td>Pillow Fight</td>
              <td>Hawks</td>
              <td>Gladiators Vs Warriors<br />Falcons Vs Jaguars</td>
            </tr>
            <tr>
              <td>9</td>
              <td>Volleyball</td>
              <td>Warriors</td>
              <td>Jaguars Vs Falcons<br />Hawks Vs Gladiators</td>
            </tr>
            <tr>
              <td>10</td>
            ...
            <tr>
              ...
              <td>Gladiators</td>
              <td>Falcons Vs Warriors<br />Hawks Vs Jaguars</td>
            </tr>
            <tr>
              <td>12</td>
              <td>Futsal</td>
              <td>Gladiators</td>
              <td>Falcons Vs Jaguars<br />Warriors Vs Hawks</td>
            </tr>
            <tr>
              <td>13</td>
              <td>Carrom (Boys)</td>
